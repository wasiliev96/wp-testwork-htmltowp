            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="img-wrapper">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/index-s2.jpg" alt=""
                             class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0s">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="section-content">
                        <h2 class="section-title">Wo stehen Sie?</h2>
                        <p class="text">Der nächste Schritt in Ihrer Karriere ist eine Führungsposition im Vertrieb oder
                            Sie sind
                            bereits Vertriebsleiter und wollen einen qualifizierten Abschluss?</p>
                        <p class="text">
                            Ein erfolgreicher Vertrieb ist der Motor eines jeden Unternehmens. Als Vertriebsleiter
                            bewegen Sie sich jedoch oftmals auf dünnem Eis.
                        </p>
                        <ul class="list">
                ...
                <div class="col-12">
                    <div class="contact-wrapper  wow zoomIn" data-wow-duration="1s" data-wow-delay="0s">
                        ...
                        <form class="contact-form">
                            ...
                            <div class="form_field"><input type="text" name="phone" placeholder="Ihre Telefonnummer">
                            </div>
